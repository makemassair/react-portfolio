    ...
    return ( 
        ...
        <div className="statement-container">
            <div className="page-statement">
                <div className="statement-block statement-home">
                    <div id="block1">
            ...
            <div className="content">
                ...
                <div className="copy">
                    <div className="copy-para">
                        <p>Until recently I was a self taught HTML + CSS web designer working primarily with WordPress.</p> 
                            
                        <p>In late 2022 I undertook a 16-week front-end web development boot camp that ran until March '23. As a result I now have foundational knowledge of JavaScript, React, ES6, JSX, Node.js, APIs, and GitHub.</p>
